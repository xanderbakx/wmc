...
const ProductsPage = () => (
  <StaticQuery
    query={graphql`
      {
        ad: file(relativePath: { eq: "CLCA_ad_8-20.jpg" }) {
          childImageSharp {
            fluid(maxWidth: 1600) {
      ...
      <Layout>
        ...
        <ProductsWrapper>
          ...
          <p className="text">
            ...
            estimate how much material you will need or you can use an{" "}
            <a
              id="calculator"
            ...
            deciding which product best suits your needs. <b>(415) 662-9849</b>
          </p>

          <p className="text">
            Compost is a soil amendment and should not be used by itself. It is
            intended to improve soil properties such as water management,
            introduce a diverse microbial population, improve soil structure and
            enhance nutrient availability throughout the growing season. It is
            not recommended to use compost by itself as a growing medium.
          </p>
          ...
          <p className="text">
            Our current products are compliant with state standards for physical
            contaminants. However, they are made from recycled materials, not
            virgin feedstocks. Very small pieces of non-organics may be found.
            All products are sold as is and all sales are final.
          </p>
          <h2 style={{ paddingTop: "1.5rem" }}>Cancellation/Refund Policy</h2>
          <p className="text">
            After you place an order you can always cancel at no cost as long as
            your delivery has not started yet. You will not be billed. Please
            cancel your orders no later than 2 hours before your scheduled
            delivery. West Marin Compost strives to have happy customers. If you
            are not satisfied please let us know. If the wrong product has been
            delivered, we will gladly replace the order with the right product.
            If our product did not perform as it should we will replace it or
            give you a refund. We will always evaluate the problem you report
            and do our best to find a solution.
          </p>
        </ProductsWrapper>
      </Layout>
    )}
